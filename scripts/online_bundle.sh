...
echo "Example with huggingface-cli on online machine:"
echo "  huggingface-cli download Qwen/Qwen2.5-Coder-32B-Instruct --local-dir ${BUNDLE_DIR}/models/Qwen2.5-Coder-32B-Instruct"
